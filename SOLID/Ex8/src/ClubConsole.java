public class ClubConsole {
    ...
    public void run() {
        IFinanceOperations treasurer = new TreasurerTool(ledger);
        IMinutesOperations secretary = new SecretaryTool(minutes);
        IEventOperations lead = new EventLeadTool(events);
